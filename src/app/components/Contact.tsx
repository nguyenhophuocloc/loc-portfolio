  ...
  return (
    <section className="section" id="contact">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form action="https://getform.io/f/bdryvmvb" className="xl:pl-10 2xl:pl-20" method="POST">
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="name"
                required
                placeholder="Nguyen Ho Phuoc Loc"
              />
            </div>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="nguyenhophuocloc.cb@gmail.com"
              />
            </div>
          </div>
